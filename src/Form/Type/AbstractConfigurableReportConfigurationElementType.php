...
abstract class AbstractConfigurableReportConfigurationElementType extends AbstractResourceType
{
    ...
    /**
     * @param ConfigurableReportConfigurationElementInterface|null $data
     */
